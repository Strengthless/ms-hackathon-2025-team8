        ...
        >
            ...
            {task.assignmentFile && (
                <Card
                    ...
                    onPress={() => Linking.openURL(task.assignmentFile)}
                >
            ...
            {completed ? (
                ...
                <View style={styles.completionSection}>
                    ...
                    <Text style={styles.feedback}>
                        {t('assignment.feedback.waitForFeedback')}
                    </Text>
                </View>
            ) : loading ? (
                // Loading State
                <View style={styles.section}>
                    <LoadingAnimation
                        text={
                            selectedFile
                                ? t('assignment.submitLoading')
                                : t('assignment.fileLoading')
                        }
                    />
                </View>
            ) : selectedFile ? (
